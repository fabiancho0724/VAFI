    ...
    async function loadData() {
      try {
        ...
        await Promise.all(years.map(async (year) => {
          try {
            const url = year === 2026 ? 'https://raw.githubusercontent.com/fabiancho0724/Nomina/7d0f179b8bbcd3d327235c8e7fe2a4f757424794/Ingreso%20Mensual%202026.csv' : `https://raw.githubusercontent.com/fabiancho0724/VAFI-Reporte-Financiero/main/Ingreso%20Mensual%20${year}.csv`;
