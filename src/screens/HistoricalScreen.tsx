...
const URL_RESUMEN_PIC = 'https://raw.githubusercontent.com/fabiancho0724/Nomina/7d0f179b8bbcd3d327235c8e7fe2a4f757424794/Resumen%20PIC.csv';
                   ...
                   {allResources.map(res => (
                     <label key={res} className="flex items-start gap-3 p-2 hover:bg-white/5 rounded-lg cursor-pointer">
                        <input 
                          ...
                          className="mt-1"
                        />
                        <span className="text-sm text-white/90 leading-tight">{res}</span>
                     </label>
                   ))}
                </div>
             </div>
